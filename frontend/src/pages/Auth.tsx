...
export default function Auth() {
  ...
  return <div data-testid="auth-page" className="grid min-h-svh bg-[#020617] text-slate-200 lg:grid-cols-[1.05fr_.95fr]">
    <div data-testid="auth-visual-panel" className="relative hidden overflow-hidden border-r border-slate-800 lg:block"><div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(6,182,212,.18),transparent_34%),radial-gradient(circle_at_80%_75%,rgba(59,130,246,.13),transparent_34%)]" /><div className="relative flex h-full flex-col justify-between p-12"><div className="flex items-center gap-3"><span className="grid size-10 place-items-center rounded-xl bg-cyan-400 text-slate-950"><Database className="size-5" /></span><span className="font-heading text-sm font-bold tracking-[.25em] text-white">WINGMAN</span></div><div className="max-w-lg"><div className="mb-5 flex size-14 items-center justify-center rounded-2xl border border-cyan-400/30 bg-cyan-400/10 text-cyan-300"><ShieldCheck className="size-7" /></div><h1 data-testid="auth-hero-title" className="font-heading text-5xl font-bold leading-[1.05] tracking-tight text-white">The clear path through your data.</h1><p data-testid="auth-hero-copy" className="mt-6 max-w-md text-base leading-7 text-slate-400">Search millions of rows, protect every department, and keep your team moving with one focused command center.</p></div><div data-testid="auth-security-note" className="flex items-center gap-3 text-xs text-slate-500"><LockKeyhole className="size-4 text-emerald-400" />Scoped access · Indexed search · Audit-ready storage</div></div></div>
    <div className="flex items-center justify-center p-6 sm:p-10"><div className="w-full max-w-md"><div className="mb-10 flex items-center gap-3 lg:hidden"><span className="grid size-9 place-items-center rounded-lg bg-cyan-400 text-slate-950"><Database className="size-5" /></span><span className="font-bold tracking-[.2em] text-white">WINGMAN</span></div><div data-testid="auth-form-header" className="mb-8"><p className="mb-3 text-[10px] font-bold uppercase tracking-[.2em] text-cyan-400">Secure workspace</p><h2 data-testid="auth-form-title" className="font-heading text-3xl font-bold text-slate-100">{title}</h2><p data-testid="auth-form-description" className="mt-2 text-sm text-slate-400">{isLogin ? "Sign in to your scoped data workspace." : isSignup ? "Request access from your workspace owner." : isForgot ? "Generate a demo-safe reset code for your account." : "Use the reset code and choose a strong password."}</p></div>
